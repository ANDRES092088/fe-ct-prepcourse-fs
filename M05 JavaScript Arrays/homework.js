...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var stringConcatenadas = palabras.join(' ');
...
function empiezaConNueve(num) {
   ...
   // Tu código:
   if (num / 1 == 9 || num / 10 < 10 && num / 10 > 8 || num / 100 < 10 && num / 100 > 8) {
      return true;
   } else {
      return false;
   }
...
function mayorACien(array) {
   ...
   // Tu código:
   var arrayMayorACien = array.filter((num) => {
      return num > 100;
   });
